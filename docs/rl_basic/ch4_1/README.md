...
<div style={{textAlign: 'center'}}>
    <figcaption style={{fontSize: '14px'}}> <b>代码 1: 时序差分估计与蒙特卡洛估计对比</b> </figcaption>
</div>
...
<div style={{textAlign: 'center'}}>
    <figcaption style={{fontSize: '14px'}}> <b>代码 2: 时序差分估计与蒙特卡洛估计结果对比</b> </figcaption>
</div>
...
<div style={{textAlign: 'center'}}>
    <figcaption style={{fontSize: '14px'}}> <b>表 1: 动态规划、蒙特卡洛和时序差分比较</b> </figcaption>
</div>
...
<div style={{textAlign: 'center'}}>
    <figcaption style={{fontSize: '14px'}}> <b>表 2 Sarsa 和 Q-learning 对比</b> </figcaption>
</div>
